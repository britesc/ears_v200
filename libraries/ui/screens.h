...
typedef struct _objects_t {
    ...
    lv_obj_t *image_button_return_3;
    ...
    lv_obj_t *image_ear_29;
    lv_obj_t *label_page_header_zap_number_entry;
    lv_obj_t *label_page_footer_zap_number_entry;
    ...
    lv_obj_t *image_ear_28;
    lv_obj_t *label_page_header_2;
    lv_obj_t *label_footer_2;
} objects_t;
...
enum ScreensEnum {
    ...
    SCREEN_ID_SCREEN_ZAP_ENTRY = 4,
    SCREEN_ID_SCREEN_INFO_1 = 5,
    SCREEN_ID_SCREEN_SYSTEM_ERROR = 6,
    SCREEN_ID_SCREEN_MAIN = 7,
    SCREEN_ID_SCREEN_BUTTONS_TEMPLATE = 8,
    SCREEN_ID_SCREEN_MAIN_TEMPLATE = 9,
};
