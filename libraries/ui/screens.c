...
static void event_handler_cb_screen_initial_setup_button_do_zap__number(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_screen_main_template_image_button_return_3(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_screen_initial_setup() {
    ...
    add_style_style_dark_screen(obj);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_pad_column(obj, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_screen_initial_setup_button_do_zap__number, LV_EVENT_ALL, flowState);
        ...
        }
        {
            ...
            add_style_style_light_message_box(obj);
...
void create_screen_screen_zap_entry() {
    ...
    add_style_style_dark_screen(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            // Image_Ear_29
            lv_obj_t *obj = lv_image_create(parent_obj);
            objects.image_ear_29 = obj;
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_image_set_src(obj, &img_ear_24_coloured);
        }
        {
            // Label_Page_Header_Zap_Number_Entry
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.label_page_header_zap_number_entry = obj;
            lv_obj_set_pos(obj, 25, 2);
            lv_obj_set_size(obj, 285, 20);
            lv_label_set_long_mode(obj, LV_LABEL_LONG_DOT);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLLABLE|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_WITH_ARROW|LV_OBJ_FLAG_SNAPPABLE);
            add_style_style_light_label_header(obj);
            lv_label_set_text(obj, "Zap Number Entry");
        }
        {
            // Label_Page_Footer_Zap_Number_Entry
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.label_page_footer_zap_number_entry = obj;
            lv_obj_set_pos(obj, 12, 226);
            lv_obj_set_size(obj, 298, LV_SIZE_CONTENT);
            lv_label_set_long_mode(obj, LV_LABEL_LONG_SCROLL_CIRCULAR);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLLABLE|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_WITH_ARROW|LV_OBJ_FLAG_SNAPPABLE);
            add_style_style_light_label_footer(obj);
            lv_label_set_text(obj, "Please Enter Your Zap Number to Begin the Configuration Process.   ");
        }
        {
            // Textarea_Zap_Number
            ...
            add_style_style_light_text_area(obj);
        }
        {
            // Keyboard_Zap_Number
            ...
            lv_obj_set_scroll_snap_x(obj, LV_SCROLL_SNAP_NONE);
            lv_obj_set_scroll_snap_y(obj, LV_SCROLL_SNAP_NONE);
            add_style_style_light_keyboard(obj);
...
void create_screen_screen_main_template() {
    void *flowState = getFlowState(0, 8);
    (void)flowState;
    lv_obj_t *obj = lv_obj_create(0);
    objects.screen_main_template = obj;
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 320, 240);
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_SNAPPABLE|LV_OBJ_FLAG_SCROLLABLE|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER);
    add_style_style_dark_screen(obj);
    {
        lv_obj_t *parent_obj = obj;
        {
            // Image_Ear_28
            lv_obj_t *obj = lv_image_create(parent_obj);
            objects.image_ear_28 = obj;
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_image_set_src(obj, &img_ear_24_coloured);
        }
        {
            // ImageButton_Return_3
            lv_obj_t *obj = lv_imagebutton_create(parent_obj);
            objects.image_button_return_3 = obj;
            lv_obj_set_pos(obj, 292, 214);
            lv_obj_set_size(obj, 24, 24);
            lv_imagebutton_set_src(obj, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &img_return_24_coloured, NULL);
            lv_imagebutton_set_src(obj, LV_IMAGEBUTTON_STATE_PRESSED, NULL, &img_return_24_coloured, NULL);
            lv_obj_add_event_cb(obj, event_handler_cb_screen_main_template_image_button_return_3, LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLLABLE|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_WITH_ARROW|LV_OBJ_FLAG_SNAPPABLE);
        }
        {
            // Label_Page_Header_2
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.label_page_header_2 = obj;
            lv_obj_set_pos(obj, 25, 2);
            lv_obj_set_size(obj, 285, 20);
            lv_label_set_long_mode(obj, LV_LABEL_LONG_DOT);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLLABLE|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_WITH_ARROW|LV_OBJ_FLAG_SNAPPABLE);
            add_style_style_light_label_header(obj);
            lv_label_set_text(obj, "Header");
        }
        {
            // Label_Footer_2
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.label_footer_2 = obj;
            lv_obj_set_pos(obj, 12, 226);
            lv_obj_set_size(obj, 275, LV_SIZE_CONTENT);
            lv_label_set_long_mode(obj, LV_LABEL_LONG_SCROLL_CIRCULAR);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLLABLE|LV_OBJ_FLAG_SCROLL_CHAIN_HOR|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_WITH_ARROW|LV_OBJ_FLAG_SNAPPABLE);
            add_style_style_light_label_footer(obj);
            lv_label_set_text(obj, "Footer Information                                  ");
        }
    }
    
    tick_screen_screen_main_template();
}

void tick_screen_screen_main_template() {
    void *flowState = getFlowState(0, 8);
    (void)flowState;
}
...
static const char *screen_names[] = { "Screen_Start", "Screen_Boot_Animation", "Screen_Initial_Setup", "Screen_Zap_Entry", "Screen_Info_1", "Screen_System_Error", "Screen_Main", "Screen_Buttons_Template", "Screen_Main_Template" };
static const char *object_names[] = { "screen_start", "screen_boot_animation", "screen_initial_setup", "screen_zap_entry", "screen_info_1", "screen_system_error", "screen_main", "screen_buttons_template", "screen_main_template", "boot_animation_logo", "button_do_zap__number", "button_do_info", "button_do__erase", "button_do_reboot", "button_message_box_confirm_erase_yes", "button_message_box_confirm_erase_no", "keyboard_zap_number", "image_button_return_2", "image_button_return", "image_button_return_3", "image_ear_25", "image_button_return_1", "label_page_header_initial_setup_screen", "label_page_footer_initial_setup_screen", "container_template_buttons_1", "button_do_password", "template_button_19", "template_button_20", "template_button_21", "template_button_22", "template_button_23", "template_button_24", "template_button_25", "template_button_27", "template_button_28", "template_button_29", "panel_message_box_erase", "label_message_box_confirm_erase", "obj0", "button_message_box_confirm_erase_text_yes", "button_message_box_confirm_erase_text_no", "image_ear_29", "label_page_header_zap_number_entry", "label_page_footer_zap_number_entry", "textarea_zap_number", "image_ear_27", "label_page_header_1", "label_footer_1", "label_static_serial_number", "label_static_zap_created", "label_static_password_created", "label_dynamic_zap_number_state", "label_dynamic_serial", "label_dynamic_password_state", "label_dark_error_system", "label_dark_error_error", "label_dark_error_code", "image_ear_26", "label_page_header_main_screen", "label_page_footer_main_screen", "container_template_buttons_2", "template_button_16", "template_button_17", "template_button_18", "template_button_26", "template_button_30", "template_button_31", "template_button_32", "template_button_33", "template_button_34", "template_button_35", "template_button_36", "template_button_37", "template_button_38", "template_button_39", "template_button_40", "image_ear_24_colured", "label_page_header", "label_footer", "container_template_buttons", "template_button_1", "template_button_2", "template_button_3", "template_button_4", "template_button_5", "template_button_6", "template_button_7", "template_button_8", "template_button_9", "template_button_10", "template_button_11", "template_button_12", "template_button_13", "template_button_14", "template_button_15", "image_ear_28", "label_page_header_2", "label_footer_2" };
static const char *style_names[] = { "Style_Light_Screen", "Style_Dark_Screen", "Style_Dark_Label_Error", "Style_Light_Label_Header", "Style_Light_Label_Footer", "Style_ImageButton_Hidden", "Style_Light_Message_Box", "Style_Light_Label_Normal", "Style_Light_Text_Area", "Style_Light_Keyboard" };
...
void create_screens() {
    ...
    create_screen_screen_main_template();
}
